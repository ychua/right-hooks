...
**Completed:** PR #11 (2026-03-23)

- ~~Wire workflow-orchestrator, inject-skill, and agents into init.js~~ — settings.json, doctor.js, agent copying, upgrade.js all updated
